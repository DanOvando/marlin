...
marlin_pal <- function(palette = "fish_scales", reverse = FALSE, ...) {
  ...
  # specify colors
  marlin_colors <- c("fin_tip" = "#13191E", 
                     "fin_mid" = "#2F385C",
                     "fin_base" = "#515680", 
                     "dorsal_tip" = "#224E5F", 
                     "dorsal_mid" = "#286073", 
  ...
  # specify palettes
  marlin_palettes <- list("fish_scales" = marlin_cols("fin_tip", "fin_mid", "fin_base", "dorsal_tip", "dorsal_mid", "ventral1", "ventral2", "lateral_line_highlight1","lateral_line", "lateral_line_highlight2", "lateral_line_highlight3"),
