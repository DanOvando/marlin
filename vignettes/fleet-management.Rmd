...
cap = 1.25 *fleets$longline$base_effort
...
As another option, you can manually specify the effort in each time step for each fleet. Inside the `fleet` object,  set `fleet_model = "manual"`, and then provide a timeseries of effort in each time step. 
