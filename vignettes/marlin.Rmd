...
fauna <- 
  list(
    "Yellowfin Tuna" = create_critter(
      ...
      adult_movement = 20,# the mean number of patches moved by adults
...
At the moment `marlin` is focused on simulating finfish species. However, in the coming weeks we intend to add support for a variety of other types of animals, including marine mammals and sea turtues. 
