...
vignette: >
  %\VignetteIndexEntry{port_distance}
...
Now we'll create a popultion of bigeye tuna. 
...
Note that this behavior is still quite basic. Distance is calculated as the euclidian distance between patches, and at this time does not support say having to travel around islands or the like. `marlin` also assumes that travel costs are just a linear function of distance. 
