...
// sim_fish
List sim_fish(const NumericVector length_at_age, const NumericVector weight_at_age, const NumericVector maturity_at_age, const NumericMatrix f_p_a, const Eigen::MatrixXd movement, Rcpp::NumericMatrix last_n_p_a, const int patches, const int burn_steps, const double steepness, const double r0, double ssb0, NumericVector ssb0_p, const double m, bool tune_unfished, const int rec_form);
RcppExport SEXP _marlin_sim_fish(SEXP length_at_ageSEXP, SEXP weight_at_ageSEXP, SEXP maturity_at_ageSEXP, SEXP f_p_aSEXP, SEXP movementSEXP, SEXP last_n_p_aSEXP, SEXP patchesSEXP, SEXP burn_stepsSEXP, SEXP steepnessSEXP, SEXP r0SEXP, SEXP ssb0SEXP, SEXP ssb0_pSEXP, SEXP mSEXP, SEXP tune_unfishedSEXP, SEXP rec_formSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(sim_fish(length_at_age, weight_at_age, maturity_at_age, f_p_a, movement, last_n_p_a, patches, burn_steps, steepness, r0, ssb0, ssb0_p, m, tune_unfished, rec_form));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_marlin_sim_fish", (DL_FUNC) &_marlin_sim_fish, 15},
    {NULL, NULL, 0}
};
